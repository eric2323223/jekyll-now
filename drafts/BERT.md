...
BERT在这项测试中不仅刷新了人工智能系统的记录，甚至超过了人类的表现，证明它的强大能力。对于机器学习算法来说，这项任务可以表示为当输入为背景介绍和问题是，对问题答案在背景介绍中的位置进行判断。由于答案的位置决定于它的起始和终止位置，而
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzMjExNTA1MCwtNzczMjIwMTUyLC04Nz
