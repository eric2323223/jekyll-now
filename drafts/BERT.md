...
- 
### 预训练流程
预训练的目的是生成能够给下游任务使用的通用模型，因此BERT在预训练中加入两个特殊token，CLS和SEP。CLS加在输入序列的开头，它也参与注意力机制训练，但由于CLS本身不包含任何意义，因此与序列中的其他元素都不相关，因此最后通过
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ0NDMxNjk0LDE3NjgzNzYzMTIsLTU2NT
