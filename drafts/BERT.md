...
- BertEncoder
BERTEncoder的主要作用是利用Transformer对每个Token进行上下文编码。BERT标准模型中的transformer有12个encoding layer，每个encoding layer都有12个多注意力
- BertPooler
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjY4MzAwODMsLTEzOTc3MTQ0MDUsLT
