...
测试数据：[MASK1]=designed, milk=computers, surrounding=surrounding, [MASK2]=establish
 ...
 - 对于为何也80%，10%和10%的比例分别进行Mask，随机词和原词替换，作者的解释是基于经验设计的比例，可能存在效果更好的比例分布，但是最终结果应该会比较接近。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyMjgwMzUyLDU3NDM4NzIyNiw4MjI1Nz
gzNjEsMTYzMjA2NjU5Miw4ODU0MzA2ODUsLTIxMjI4NjE0OTEs
MjExMjI0NjU0NywtMTA5MzU4Nzc5MCwxNjg2MDQyNTI5LDE4ND
