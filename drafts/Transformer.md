...
$$c_i=\sum_{j=1}\alpha_{ij}h_j$$
从这个定义可以看出attention的结果$c$就是序列中所有元素按一定的比例关系相加得到的，由于$c$具备了序列的上下文信息，因此我们也可以把attention理解为**元素在某一个序列上下文环境中的重新定义**。这个特点是attention
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAyNjU5MjIzMiwtMTM2MDI0MDA1OCwtMj
