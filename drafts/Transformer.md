...
### 编码/解码层
transformer模型中在HMA之后输入按位前馈网络，这里按位主要是指每个位置的元素各自输入前馈网络里进行计算，网络通常为2c
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjY2MDc3NDY5LDExOTQ5ODk3MjEsMjcwMz
...
MjIsNDI3ODE2NjY4LDEzODI0NTYyMDUsLTIwNzQ2MTcyMTAsND
