...
注意力机制主要用于seq2seq任务，它的基本思想就是将人类快速阅读的方式应用在序列分析上。不同于RNN中先通过依次叠加context vector的依次累加输入的生成方式，解码器直接访问所有输入序列中的元素，在
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQxMDM4NzA0MCw1MTY1MDI5NjUsLTU1ND
