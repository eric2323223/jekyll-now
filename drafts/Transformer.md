...
标签平滑归一化通过"软化"传统的独热one-hot类型编码，使得在计算误差值时能够有效抑制过拟合现象。如下图所示，label smoothing相当于减少真实样本标签的类别在计算损失函数时的权重，最终起到抑制过拟合的效果。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTA5MTI4NjkxLC01MzU1MjQ0MTQsMTY5MD
ExMDkzMiwxMDQ1OTE4OTIxLDE3MjgzNDczNTEsMTE4NjAzOTM3
MCwtNzA3MzA0NDM2LDExMjEzMjY0MzcsMTYwMzUxNTkyOSwzNj
k4NzY4ODAsLTEyOTg3NDE1MDgsLTExNTMyMzgzMDksMTQzMjk4
Mjc4NSwxOTE4NjQwODM3LC0yMTAyMDkzOTYxLDc0MzQwMDgxNy
wyMDA1NDc5MzMyLDE4ODc3NDA1ODIsOTc1NjgxNDQ4LDEwOTQ3
ODU5MTZdfQ==
-->