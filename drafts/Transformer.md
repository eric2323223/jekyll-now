...
注意力机制主要用于seq2seq任务，它的基本思想就是将人类快速阅读的方式应用在序列分析上。不同于RNN中先通过依次分析输入元素来获得context vector的方式，注意力机制对这些输入元素进行加权平均的方式来一步生成context vector。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI2MzY0NjUyLDY0MzgzMDY1LDUxNjUwMj
