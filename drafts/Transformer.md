...
>
> 训练初期由于离目标较远，一般需要选择大的学习率，但如果训练数据集具有高度的差异性则使用过大的学习率可能导致不稳定性。这是由于如果初始化后的数据恰好包含一组相关的，功能强大的观察结果，则模型的初始训练可能会严重偏向于这些功能，或者更糟的是，偏向于与主题完全不相关的附带功能。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5ODI4ODQxNywzNjA5NjA5ODEsOTIzNT
