...
### regularization
- Layer normalization
  Normalization是在机器学习中常用的一种数据预处理方法，主要目的是将数据“白化”Whitening，也就是在统计学中常常提到的“独立同分布”，它代表两个要素：
  1. 独立	特征之间相关系要低
  2. 同分布	所有特征应该具有xiangtu
	LN vs. BN
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYwNjA4Nzk4MiwxNjAzNTE1OTI5LDM2OT
