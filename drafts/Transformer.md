...
解码器需要两个输入来生成输出，第一个输入是上一步的解码器输出（第一个jiemaqi输出由一个固定的标识编码充当）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDIzODQwODksNDc1MjEzMTgsLTYwNj
...
MDY0MywxMzEzMzY1NjM2LDExNTkzMDc5OTYsLTk0MTIyNTM2Ni
w2NjY0NTE5MjIsNDI3ODE2NjY4LDEzODI0NTYyMDUsLTIwNzQ2
MTcyMTBdfQ==
-->