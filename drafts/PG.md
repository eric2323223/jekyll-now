...
$$
\nabla_\theta J(\theta) \approx \mathbb E_{\tau\sim\pi_\theta(\tau)}[(\sum_{t=1}^Tlog\pi_\theta(a_t|s_t))(\sum_{t=1}^Tr(s_t,a_t))]
$$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA2NTc2OTc0NywxNzIzMDk3NjA2LDE5Nz
QxMzAyOThdfQ==
-->