...
$$
$\mathbb E[r_0+r_1+r_2+...+r_t|\pi_\theta]$表示在策略$\pi_\theta$条件下一轮交互（$t_0$到$t_t$步）中的累计奖励的期望值，这里是期望而不是确定值的原因是每一步的奖励$r=\pi(s
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxOTg1NTIzMSwtNzA2MDk2MjNdfQ==
-->