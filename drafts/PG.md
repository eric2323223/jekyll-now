...
### PG应用
通过实例介绍如何应用PG解决具体问题，学习玩Atari Pong游戏。 PONG是一个模拟打乒乓球的游戏，玩家控制屏幕一侧的一小块平面（模拟乒乓球拍）上下移动来击球。如果迫使对方失球则己方一侧的得分加一，反之对方得分。使用PG学习PONG游戏的过程可以分为一下几个阶段。
1. 建模
学习的目的是理解如何控制球拍（即上下移动），而依据当前球拍的位置和球的速度位置信息，这些信息通过观察屏幕得到的。另外还需要通过观察
3. 
...
- 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEyMDg0NjAxNCw4OTk2NjEwNiwtNDc3Mz
