...
6.  轮次(Episode): 表示从起始状态开始使用某种算法产生动作与对象系统交互，直到某个终结状态结束。比如一次Atari游戏，在围棋游戏中的一个轮次就是从棋盘中的第一个落子开始直到对弈分出胜负，或者自动驾驶的轮次指从汽车启动一直到顺利抵达指定的目的地，当然撞车或者开进水塘也是种不理想的终结状态。
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQyMTg3MjA1OSwxODcxMDMzNTQ3LDE3Mj
MwOTc2MDZdfQ==
-->