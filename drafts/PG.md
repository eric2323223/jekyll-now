...
**Episode轮次**: 表示从起始状态开始使用某种策略产生动作与对象系统交互，直到某个终结状态结束。比如在围棋游戏中的一个轮次就是从棋盘中的第一个落子开始直到对弈分出胜负，或者自动驾驶的汽车顺利抵达指定的目的地，当然撞车或者开进水塘也是不理想的终结状态。
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE1NjM1NTA4NiwxNTY3MzIwMjE4XX0=
-->