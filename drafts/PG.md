...
>强化学习其实也是机器学习的一个分支，但是它与我们常见监督式学习（supervised learning）不太一样。强化学习方式更加接近人类的学习，即通过一系列的changs一个目标，是一种**序列多步决策**的问题。
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNjAyMzExMTcsLTg1ODMzNzczNCwxND
