...
### 实现
我们知道在监督式学习中一般会选择一种loss function, 如square loss, Hinge loss, logistic loss等，来表示真实值和实际值的差距从而在反向传递中进行参数的更新。在强化学习中
#### PG的目标函数
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg3NjUwNzI1NCwtNDc3MzMwMzE3LC04NT
