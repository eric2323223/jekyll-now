...
那么如何引导模型选取合适的关键特征呢？最直接的方法就是不做筛选使用全部的特征来计算不同个体特征之间的距离，当两个个体之间的特征距离足够进的时候，就认为是同一个体，反之j这就是contrasitive loss
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTMyMjg3NDgwLC0yNTkzNTI2OCwtMTgzNj
