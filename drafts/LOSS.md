...
### 连续性
虽然GD要求loss function连续可导，但在实践中loss function可以存在不连续的点，这是因为计算是使用一组（batch）数据的loss均值进行求导，这样loazminibatch GD允许loss function在个别点不连续
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDQ3MzYyOTEsMjAwMDEwOTcwNywtNj
