...
- 适用于回归问题（Regression）的误差函数，这种误差函数的目标是量化推测值和真实值的差距，因此
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDA2NDE5MTAsLTE3NDMyNDYxMDYsMj
A4MDkwOTM3MSwtODc3NTk2NjY5LC0xMDcyOTk3MzYzLDM3NjA4
MzA2LDcwNTY1MDgzM119
-->