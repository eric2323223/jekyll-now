...
Loss function虽然可以引导GD进行模型的优化，但是一个常见的问题是模型虽然达到了很高的训练准确率，但是测试准确率却有较大的落差，这就是过拟合（over fitting）现象。这种问题源自于模型为了提高训练准确率学习了训练数据中的噪声从而导致模型和真实规律产生偏差。generalization就是解决过拟合问题的常见方法之一，它的原理是把参数加入loss
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5NDM5MzEwMSwtMTAwMDM3OTUxMiwtMT
gwNzU5MjY1NSwyMDAwMTA5NzA3LC02NjcxMzEwNzMsLTc3NjE2
NzEzNywtMTA2NDk1ODMxOCwxODExMjQ1ODMxLDEyMjcyOTAwND
ksLTE5MjU3NjI2NywtMTcyMjMzNjI0OCwtMTEwOTcyMzIyMSwx
NDkyNTI5MDE1LDE0OTI1MjkwMTUsLTEwNDYzMzQ0OSwtMTU4Mj
g1MzQ0NCwtNzQ2MDgwNTA2LDExNzE3NDA4NSwtMjk2MTA2MTUw
LC0xOTEzNjY3NTQzXX0=
-->