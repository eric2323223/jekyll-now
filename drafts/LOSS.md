...
误差函数$L$就是被设计出来的一个关于$\theta$的用来衡量预测值和真实值之间的差距的函数，这样通过求当这个距离达到最小值的时候我们就认为模型达到最好的状态。所以机器学习实际上是一个通过优化$L_\theta$（求最小值）来计算$\theta$的过程。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzg0NzM2ODIzLC02OTkwOTA4NzgsMTA4ND
