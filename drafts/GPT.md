...
GPT的作者之前的一些研究中发现了大量的文本训练可以让基于RNN模型学习到一些可辩别的特征（discriminative features）， 为了验证这些学习到的特征具有通用性，并且可以应用于多种微调任务，作者设计了这样的迁移学习场景，了多个微调任务场景测试首先对基于Transformer模型应用大量预料进行自监督训练，然后利用    学习到的特征
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM5Njc4ODU2NSw4NjcwMDE1NzEsMTA5OT
